...
screen drag_puzzle():
    ...
    add Transform("frame.png", size=(600, 600)) xpos 700 ypos 123 alpha 1
    draggroup:
        ...
        drag:
            ...
            xpos 1600
            ypos 600
            add Transform("piece_1.png", size=(350, 350))
        ...
        drag:
            ...
            xpos 600
            ypos 600
            add Transform("piece_2.png", size=(350, 350))
        ...
        drag:
            ...
            xpos 1400
            ypos 100
            add Transform("piece_3.png", size=(350, 350))
        drag:
            drag_name "piece_4"
            draggable True
            droppable False
            ...
            xpos 400
            ypos 200
            add Transform("piece_4.png", size=(350, 350))
        drag:
            drag_name "piece_5"
            draggable True
            droppable False
            ...
            xpos 200
            ypos 200
            add Transform("piece_5.png", size=(350, 350))
        drag:
            drag_name "piece_6"
            draggable True
            droppable False
            ...
            xpos 700
            ypos 650
            add Transform("piece_6.png", size=(350, 350))
        drag:
            drag_name "piece_7"
            draggable True
            droppable False
            ...
            xpos 420
            ypos 80
            add Transform("piece_7.png", size=(350, 350))
        drag:
            drag_name "piece_8"
            draggable True
            droppable False
            ...
            xpos 1400
            ypos 500
            add Transform("piece_8.png", size=(350, 350))
        drag:
            drag_name "piece_9"
            draggable True
            droppable False
            ...
            xpos 200
            ypos 600
            add Transform("piece_9.png", size=(350, 350))
        # Drop zones
        drag:
            drag_name "1"
            draggable False
            ...
            xpos 640
            ypos 82
            add Transform("slot_1.png", size=(350, 350)) alpha 0
        ...
        drag:
            ...
            xpos 824
            ypos 60
            add Transform("slot_2.png", size=(350, 350)) alpha 0
        ...
        drag:
            ...
            xpos 1012
            ypos 90
            add Transform("slot_3.png", size=(350, 350)) alpha 0 
        drag:
            drag_name "A"
            draggable False
            droppable True
            xpos 660
            ypos 247
            add Transform("slot_4.png", size=(350, 350)) alpha 0 
        drag:
            drag_name "B"
            draggable False
            droppable True
            xpos 825
            ypos 247
            add Transform("slot_5.png", size=(350, 350)) alpha 0
        drag:
            drag_name "C"
            draggable False
            droppable True
            xpos 988
            ypos 247
            add Transform("slot_6.png", size=(350, 350)) alpha 0
        drag:
            drag_name "D"
            draggable False
            droppable True
            xpos 628
            ypos 417
            add Transform("slot_7.png", size=(350, 350)) alpha 0
        drag:
            drag_name "E"
            draggable False
            droppable True
            xpos 825
            ypos 442
            add Transform("slot_8.png", size=(350, 350)) alpha 0 
        drag:
            drag_name "F"
            draggable False
            droppable True
            xpos 1015
            ypos 412
            add Transform("slot_9.png", size=(350, 350)) alpha 0
# --- Winning state ---
label puzzle_win:
    ...
    pause 2.0
    "Puzzle Solved!"
    show ethan-picture at center with dissolve
    Ethan "A picture of me?"
    "Main Key Obtained"
    Ethan "Huh? I got a key..."
